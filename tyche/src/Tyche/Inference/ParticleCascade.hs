...
pcD :: Ord a => Int -> Model a -> MWC.Prob IO (Dist a)
...
resample :: Int -> Double -> [Particle a] -> MWC.Prob IO [Particle a]
...
branch :: Int -> Double -> Particle a -> MWC.Prob IO (Int, Double)
